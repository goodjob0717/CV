...
<body>
	...
	<div class="content">
		<form name="cv_form" action="write" method="post">
			...
			<table id="user_info" border="1" style="height: 150px; border-radius: 5px;"><!-- 개인정보 -->
				<tr>
				  	<td width="10%">
						<div class="user_info">
							<input type="text" placeholder="이름*" name="cv_name" required>
						</div>
				  	</td>
				  	<td width="15%">
						<div class="user_info">
						<input type="date" placeholder="생년월일*" name="cv_birth" required>
						</div>
					</td>
					<td class="left" width="5%">
						<div class="user_info">
							<select name="cv_sex" required>
					...
					<td width="35%">
						<div class="user_info">
						<input type="email" placeholder="이메일*" name="cv_email" required>
						</div>
					</td>
					<td rowspan="2">
						<input type="file" onchange="readURL(this);"> 
						<img id="preview" style="width: 103px; height: 132px;"/>
				  	</td>
				</tr>
				<tr>
					<td colspan="1" width="25%">
						<div class="user_info">
						<input type="tel" placeholder="휴대폰번호" name="cv_phone" required>
						</div>
					</td>
					<td colspan="3" width="70%">
						<div class="user_info">
							<input type="text"placeholder="주소" name="cv_address" required>
						</div>
					</td>
					</tr>
			</table><br><!-- end 개인정보 -->
		...
		<table id="education" border="1">
			<tr>
				<td class="left">
					<select name="e_school" id="dropdown" onchange="showTable(this.value)">
					...
					<div id="tableContainer">
						<table id="highschool" class="hidden" border="1">
							<tr>
								...
								<td>
									<div class="item">
										졸업년월 <input type="text" name="e_hi_endMon">
									</div>
								</td>
								<td>
									<div class="item"> 
						...
						<table id="university" class="hidden" border="1">
							<tr>
								...
								<td>
									<div class="item">
										입학년월* <input type="date" name="e_uni_startMon">
									</div>
								</td>
								<td>
									<div class="item">
										졸업년월* <input type="date" name="e_uni_endMon">
									</div>
								</td>
								<td rowspan="2">
									<div class="item"> 
							...
							<tr>
								<td>
									<input type="text" placeholder="전공명*" name="e_major">
								</td>
								<td>
									<input type="text" placeholder="학점" name="e_credit">
								</td>
								<td>
									<input type="number" placeholder="총점" name="e_score">
								</td>
							</tr>
						</table>
					</div>
		...
		<h2 id="career_bar">경력</h2>
			<table id="career" border="1"><!-- 경력 -->
				<tr>
					<td width="40%">
						<div class="item">
							<input type="text" placeholder="회사명" name="c_corpName" class="c_corpName">
						</div>
					</td>
					<td width="40%">
						<div class="item">
							<input type="text" placeholder="부서명" name="c_dept">
						</div>
					</td>
					<td width="10%">
						<div class="item">
							입사년월 <input type="date" placeholder="입사년월" name="c_startMon">
						</div>
					</td>
					<td width="10%">
						<div class="item">
							퇴사년월 <input type="date" placeholder="퇴사년월" name="c_endMon">
						</div>
					</td>
				</tr>
				<tr>
					<td>
						<div class="item">
							<input type="text" placeholder="직급/직책" name="c_position">
						</div>
					</td>
					<td class="left">
						<div class="item">
							<input type="text" placeholder="담당직무" name="c_duty">
						</div>
					</td>
					<td colspan="2">
						<div class="item">
							<input type="number" placeholder="연봉" name="c_salary">
						</div>
					</td>
				</tr>
				<tr>
		...
		<h2 id="activity_bar">경험/활동</h2>
			<table border="1"><!-- 활동 -->
				<tr>
					<td width="10%">
						<div class="item">
							<select name="a_activitySort" id="a_activitySort">
					...
					<td colspan="4" width="70%">
						<div class="item">
							<input type="text" placeholder="회사/기관/단체명*" name="a_corpName">
						</div>
					</td>
					<td width="10%">
						<div class="item">
							시작년월 <input type="date" placeholder="시작년월" name="a_startMon">
						</div>
					</td>
					<td width="10%">
						<div class="item">
							종료년월 <input type="date" placeholder="종료년월" name="a_endMon">
						</div>
					</td>
				</tr>
				<tr>
		...
		<h2 id="training_bar">교육</h2>
			<table border="1"><!-- 교육 -->
				<tr>
					<td width="40%">
						<div class="item">
							<input type="text" placeholder="교육명*" name="t_name">
						</div>
					</td>
					<td width="40%">
						<div class="item">
							<input type="text" placeholder="교육기관" name="t_institution">
						</div>
					</td>
					<td width="10%">
						<div class="item">
							시작년월 <input type="date" placeholder="시작년월" name="t_startMon">
						</div>
					</td>
					<td width="10%">
						<div class="item">
							종료년월 <input type="date" placeholder="종료년월" name="t_endMon">
						</div>
					</td>
				</tr>
				<tr>
		...
		<h2 id="license_bar">자격증</h2>
			<table border="1">
				<tr>
					<td width="40%">
						<div class="item">
							<input type="text" placeholder="자격증명*" name="l_name">
						</div>
					</td>
					<td width="40%">
						<div class="item">
							<input type="text" placeholder="발행처/기관" name="l_institution">
						</div>
					</td>
					<td width="20%">
						<div class="item">
							취득년월 <input type="date" placeholder="취득년월" name="l_passMon">
						</div>
					</td>
				</tr>
			</table><br>
			...
			<table border="1">
				<tr>
					<td colspan="2" width="40%">
						<div class="item">
							<input type="text" placeholder="수상 공모전명" name="p_name">
						</div>
					</td>
					<td width="40%">
						<div class="item">
							<input type="text" placeholder="수여 주최기관" name="p_corp">
						</div>
					</td>
					<td width="20%">
						<div class="item">
							수상 공모일<input type="date" placeholder="수상 공모일" name="p_date">
						</div>
					</td>
				</tr>
			</table><br>
		...
		<h2 id="portfolio_bar">포트폴리오</h2>
			<table border="1">
				<tr>
					<td width="20%">
						<select id="dropdown" name="po_sort">
							<option value="" selected>구 분</option>
					...
					<td width="80%">
						<input type="text" placeholder="url" name="po_url">
					</td>
				</tr>
			</table><br>
